  ...
  server.registerTool(
    'transkribus_model_list',
    {
      ...
      inputSchema: z.object({
        ...
        releaseLevel: intCoerce(z.number().int()).optional().describe('Filter by release level'),
  ...
  server.registerTool(
    'transkribus_model_get',
    {
      ...
      inputSchema: z.object({
        ...
        facetLimit: intCoerce(z.number().int()).optional().default(10).describe('Facet limit'),
        minFacetCount: intCoerce(z.number().int()).optional().default(2).describe('Minimum facet count'),
